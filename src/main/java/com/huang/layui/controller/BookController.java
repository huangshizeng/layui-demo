package com.huang.layui.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.huang.layui.exception.JsonParseException;
import com.huang.layui.model.Book;
import com.huang.layui.service.BookService;
...
public class BookController {
    ...
    public ResponseEntity<Page<Book>> searchBooks(@RequestParam("page") int page,
                                                  @RequestParam("limit") int limit) {
        return ResponseEntity.ok(bookService.searchBooks(page, limit));
    }
